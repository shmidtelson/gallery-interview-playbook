...
def build():
    ...
    story = [
        ...
        P(
            ...
            "и работу с фаундером без дейликов. Кандидат — backend на Laravel в аутстаффе. "
            "Коммерческого Symfony нет, значит и Doctrine в проде не было. React сейчас не пишет. "
            "Спринтов нет (канбан). Есть daily, SDM и простой, когда доска пустая."
        ),
        ...
        table(
            [
                ...
                [
                    "Doctrine / миграции",
                    "Нет",
                    "Нет Symfony в проде — нет и Doctrine. Сравнение с Active Record это теория, не миграции.",
                ],
                [
                    "React, router v6",
                    "Нет",
                ...
                [
                    ...
                    "Нет",
                    "Daily, SDM, архком. Около месяца простой, пока доску не пополнили.",
                ],
                [
                    "Stripe, Go, Next.js",
                    "Не опора",
        ...
        P(
            "Отказ держат Symfony (и Doctrine), React и зависимость от daily/SDM, не отсутствие спринтов. "
        ...
        table(
            [
                ...
                [
                    ...
                    "2",
                    "Laravel подтверждён. Symfony и Doctrine в проде не было.",
                ],
                [
                    "React",
                    "2",
                ...
                [
                    "Автономия",
                    "2",
                    "Канбан без спринтов — да. Daily и простой без бэклога — не контур «один на фаундера».",
                ],
                [
                    "AI",
                    "3",
        ...
        P(
            "1. <b>Срок выхода.</b> Нужно осваивать Symfony и Doctrine на вашей базе. Один исполнитель — простой поставки.",
            LI,
        ),
        P(
        ...
        P(
            "4. <b>Контур управления.</b> Спринтов нет. Есть daily и SDM. Около месяца ждал, пока доску пополнят.",
            LI,
        ),
        KeepTogether(
            [

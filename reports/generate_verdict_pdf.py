...
def build():
    ...
    story = [
        ...
        P("Общий балл: 2.5 из 4 · сумма 15 из 24 · обязательные 2.4 из 4", DEC),
        P(
        ...
        table(
            ...
            [78 * mm, 22 * mm, 22 * mm, 56 * mm],
        ),
        P(
            "По обязательным 2.4 — отказ. Оговорка из‑за AI, баллы вверх не округлялись.",
            META,
        ),

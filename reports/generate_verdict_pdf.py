...
def build():
    ...
    story = [
        ...
        P(
            ...
            "Коммерческого Symfony нет, значит и Doctrine в проде не было. React сейчас не пишет. Формат работы — команда, daily, "
        ...
        P(
            "Обязательные пункты по Symfony (и Doctrine), React и формату работы не закрыты. "
